...
public abstract class ReflectionUtils {
	...
	public static String toGetterName(String name){
		return "get"+name.substring(0,1).toUpperCase().toUpperCase()+name.substring(1);
	}
	...
	public static String toSetterName(String name){
		return "set"+name.substring(0,1).toUpperCase().toUpperCase()+name.substring(1);
	}
