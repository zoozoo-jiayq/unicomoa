...
public abstract class ServletUtils {
	 ...
	 */
	public static Map<String, Object> getParametersStartingWith(ServletRequest request, String str) {
		String strPrex = str;
		...
		while (paramNames != null && paramNames.hasMoreElements()) {
			...
			if ("".equals(strPrex) || paramName.startsWith(strPrex)) {
				String unprefixed = paramName.substring(strPrex.length());
	...
	public static List<String> getParameterValues(ServletRequest request,String name) {
		...
		if (ArrayUtils.isNotEmpty(values)) {
			CollectionUtil.addAll(list,values);
		} else {
