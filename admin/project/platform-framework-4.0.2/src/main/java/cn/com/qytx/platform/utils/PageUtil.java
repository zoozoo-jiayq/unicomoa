	  ...
	  /**
		 ...
		 */
		  public  static String getAjaxPageHtml(Page pageInfo) {
		        ...
		        sb.append("<div class=\"pt5 pb10 pl20 pr20\">");
		        sb.append("<div class=\"dataTables_info\" style=\"margin-left:-25px\" id=\"Table_info\">共 "+  totalCount+" 条数据 </div> ");
		        sb.append("<div class=\"dataTables_paginate paging_full_numbers\" style=\"margin-right:-28px\" id=\"Table_paginate\">");
		        ...
		        if(pageCount>0) {
		           ...
		           sb.append("<span>"); 
		            if(pageCount>10){
		                //如果大于10，则显示10条
		                int index=pageNo/10;//获取当前页码
		                int step =10;
		                for(int i=10*index;i<10*index+step;i++){
		                    if(i<totalPage){
		                    	if(pageNo==(i+1)){
