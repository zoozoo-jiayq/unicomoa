...
public class ChineseCalendar {
    ...
    private final static String CHINANUMBER[] = {
...
//======   传入   offset   传回干支,   0=甲子
    ...
    public String getChineseMouthDay() {
        return CHINANUMBER[month - 1] + "月" + getChinaDayString(day);
    }
    ...
    public String toString() {
        return getCyclical() + "年" + (leap ? "闰" : "") + CHINANUMBER[month - 1] + "月" +
    ...
    private void dateChange(Calendar cal) {
    	SimpleDateFormat chineseDateFormat1 = new SimpleDateFormat(
                "yyyy年MM月dd日");
        int monCyl;
        int leapMonth = 0;
        Date baseDate = null;
        ...
        int offset = 0 ;
        if(baseDate!=null){
        	offset = (int) ((cal.getTime().getTime() - baseDate.getTime()) /
        			86400000L);
