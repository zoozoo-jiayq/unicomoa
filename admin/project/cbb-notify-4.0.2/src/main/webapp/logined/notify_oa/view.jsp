...
<style type="text/css">
	...
	.detailsContent p, .detailsContent div{
		text-indent:0;
	}
</style>
<script type="text/javascript" src="${ctx}js/logined/notify/view.js"></script>
</head>
<body>
...
<div class="detailsPage">
	<div class="detailbg">
	<h2 id="subject"></h2>
    <h3><span id="createTimeStr"></span><span id="createUserName"></span><span  id="viewCount"></span></h3>
    <div class="detailsContent">
	     <div id="content" ></div>
    </div>
  
    <div class="expFile" id="fileListDiv" style="display:none;">
    ...
    <s:if test="#request.returnType==1">
   	...
   	<%-- <span class="blue">点击返回，回到列表。</span> --%>
    </div>
</div>
</body>
</html>
