...
<script type="text/javascript" src="${ctx}js/logined/notify/transmit.js"></script>
</head>
<body>
...
<div class="formPage">
	...
	<div class="buttonArea"> 
			<input hideFocus="" value="发布" class="formButton_green" type="button" onClick="tijiao(2)" id="fb"/>
