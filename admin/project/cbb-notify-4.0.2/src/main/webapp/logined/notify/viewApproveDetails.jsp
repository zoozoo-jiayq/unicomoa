...
<script type="text/javascript" src="${ctx}js/logined/notify/viewApproveDetails.js"></script>
</head>
<body>
  ...
  <div class="formbg">
	...
	<tbody>
          ...
          <div class="small_title">审核意见</div>
      		...
      		<tbody>
          		<tr>
            	<th width="70px"><label>审核意见：</label></th>
            	<td id="approveStatus">
...
<!-- 				valid="required" errmsg="notify.notify_reason_not_null" -->
	...
	<div class="buttonArea">
			<input hideFocus="" class="formButton_grey" value="返回" type="button" onclick="javascript:window.location.href = document.referrer;"/><span class="blue">点击返回，回到列表。</span>
	</div>
	</form>
</div>
</body>
