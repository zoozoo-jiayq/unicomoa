...
function submit(){
	...
	if(!$("#locationStr").is(":hidden")){
		location=$("#locationStr").text();
	}
	var longitude=$("#longitude").val();
	var latitude=$("#latitude").val();
	var range=$("#range").val();
	var commonOn=$("#commonOn").val();
	var commonAmOff=$("#commonAmOff").val();
	var commonPmOn=$("#commonPmOn").val();
	...
	var param={
			...
			'vo.commonAmOff':commonAmOff,
			'vo.commonPmOn':commonPmOn,
