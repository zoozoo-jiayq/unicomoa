package cn.com.qytx.cbb.file.service.impl.xssf.converter;
...
public class XlsxConverter implements IConvert {
	...
	public XlsxConverter(String filePath, String output) throws IOException, InvalidFormatException, ParserConfigurationException{
	 ...
	 */
	public  void convert(String filePath, String output,final String imagesPhysicalPath,String imageUrl,String htmlTitle ) throws InvalidFormatException, IOException, ParserConfigurationException, TransformerException{
		...
		converter.htmlDocumentFacade.setTitle(htmlTitle);
