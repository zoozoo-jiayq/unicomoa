...
public class AffairsImpl extends BaseServiceImpl<Affairs> implements IAffairs{
	...
	public List<Affairs> findAffairsListByFlag(int remindFlag) {
		  return affairsDao.findAffairsListByFlag(remindFlag);
	}
    /**
     * 
	...
	public int updateAffairsFlag (String affairsIds,int remindFlag) {
		return affairsDao.updateAffairsFlag(affairsIds, remindFlag);
	}

	@Override
	public Page<Affairs> findPageByUserId(Pageable pageable, Integer userId) {
		return affairsDao.findPageByUserId(pageable, userId);
	}

	@Override
	public int getUnReadAffairs(int userId) {
		return affairsDao.getUnReadAffairs(userId);
	}

	@Override
	public int updateRedAffairsFlag(int userId, int remindFlag) {
		return affairsDao.updateRedAffairsFlag(userId,remindFlag);
	}
