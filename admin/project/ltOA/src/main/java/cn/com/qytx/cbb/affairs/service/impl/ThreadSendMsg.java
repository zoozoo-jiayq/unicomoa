...
public class ThreadSendMsg implements Runnable {
	...
	public int  sendPush(UserInfo fromUserInfo ,String pushSubject,String pushContent, String moduleName,
    	...
    	Gson json = new Gson();
    	pushPlatService.pushJpushToPlat(companyId, tag, PLAT_TYPE.ANDROID, pushContent, pushSubject, json.toJson(extra), JPUSH_PUSH_TYPE.TAG, null,ANDROID_PUSH_TYPE.MESSAGE);
