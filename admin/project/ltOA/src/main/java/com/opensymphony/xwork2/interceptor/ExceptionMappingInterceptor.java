...
import cn.com.qytx.monitor.client.AlarmLevel;
import cn.com.qytx.monitor.client.MonitorAlarm;
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        try {
            result = invocation.invoke();
              ...
              if(mesg.length()>100){
              	mesg = mesg.substring(0, 100);
              }
              MonitorAlarm.alarmError(AlarmLevel.ERROR_101, mesg);
            if (isLogEnabled()) {
                handleLogging(e);
            }
