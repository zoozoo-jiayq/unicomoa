...
function addTab(tabid, url, name, showCloseBtn, mothodList) {
    ...
    if (document.getElementById("div_" + tabid) == null) {
        ...
        {
            litxt = "<span><a href=\"javascript:void(0);\" title=" + name + " class=\"menua\"  onclick=\"switchTab('"+tabid+"')\" >" + name + "</a><a onclick=\"closeTab('" + tabid + "')\" class=\"win_close\" title=\"关闭当前窗口\"><a></span>";
        }
        else {
