		...
		function _fnAjaxUpdate( oSettings )
		{
			if ( oSettings.bAjaxDataGet )
			{
				...
				oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aoData,
					function(json) {
					var pageLength = Math.ceil(json.iTotalRecords/ oSettings._iDisplayLength );
					if(pageLength<=1){
						var pageFootId = oSettings.sTableId+'_paginate';
						var pageFoot = document.getElementById(pageFootId);
						if(pageFoot){
