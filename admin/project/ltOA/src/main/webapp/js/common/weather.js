...
{
    var dataParam={
        'url':'http://61.4.185.209/data/cityinfo/101180101.html' // 信阳101180601 郑州101180101  101181601=驻马店   焦作:101181101
    };
    ...
    $.ajax({
        ...
        success:function(msg){
            if(msg!=""&&msg!="8EF0000"){
                ...
                $("#w_temperature").html(obj['weatherinfo']['temp2']+"~"+obj['weatherinfo']['temp1']);
            }
        }
    });
}