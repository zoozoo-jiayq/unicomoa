...
<head>
<title><%=LogoConfig.getInstance().getSysName() %></title>
...
<div id="iecheck" class="prompt" style="display:none;"><em></em>您的IE浏览器版本过低，可能存在兼容性问题和安全隐患，建议您升级至IE10以上版本或<a href="${ctx }down/GoogleChromeframe.zip">安装插件</a></div>
   <span class="logo"><%if(LogoConfig.getInstance().getLogoUrl()!=null && !LogoConfig.getInstance().getLogoUrl().equals("")){ %><img src="${ctx}filemanager/prevViewByPath.action?_clientType=wap&filePath=<%=LogoConfig.getInstance().getLogoUrl() %>" alt=""  heigth="38px" /><%}%><%=LogoConfig.getInstance().getSysName() %>
      </span>
...
<div class="login_cont">
   <div class="main_lc">
           ...
           <a href="#" class="az_xz" title="安卓下载">
               <h3>安卓版下载</h3>
               <p>版本号：v3.0.7</p>
               <p>更新时间：2014/4/12</p>
           </a>
           <a href="#" class="iphone_xz" title="iphone下载">
           	   <h3>iphone版下载</h3>
               <p>版本号：v3.0.7</p>
               <p>更新时间：2014/4/12</p>
           </a>
