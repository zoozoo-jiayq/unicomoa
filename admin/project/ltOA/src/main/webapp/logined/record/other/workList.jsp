...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/logined/record/other/workList.js"></script>
...
<div class="list">
      ...
      <table cellspacing="0" cellpadding="0">
          ...
          <tr>
            	<td class="right">&nbsp;</td>
	               ...
	               <div class="fButton greenBtn">
	              	 <span class="add" onclick="editorWorkDeatil()" >新增</span> 
	               </div>
	               <div class="fButton greenBtn" >
        ...
        <table id="dataTable_work" cellpadding="0" cellspacing="0" class="pretty dataTable">
            <thead>
            <tr>
                  <th class="num" id="num">序号</th>
                  <th style="width:90px;"  >员工姓名</th>
                  <th style="width:100%;"  >工作单位</th>
                  <th style="width:100px;" id="job">行业类别</th>
                  <th style="width:100px;" id="nationality">担任职务</th>
                  <th style="width:90px;" id="birthDay">证明人</th>
