...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/logined/record/other/transferList.js"></script>
      ...
      <table cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            	<td class="right">&nbsp;</td>
	               ...
	               <div class="fButton greenBtn" id="btnAddTransfer" >
	              	 <span class="add" >新增</span> 
	               </div>
	               <div class="fButton greenBtn" id="btnRefreshTransfer" >
        ...
        <table id="dataTable_record" cellpadding="0" cellspacing="0" class="pretty dataTable">
            ...
            <tr>
                  ...
                  <th style="width:100px;" id="userName" >调动人员</th>
                  <th style="width:90px;" id="transferType">调动类型</th>
                  <th style="width:100px;" id="transferDate">调动日期</th>
                  <th style="width:90px;" id="effectiveDate">调动生效日期</th>
