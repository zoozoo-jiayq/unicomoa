...
<head>
    ...
    <script type="text/javascript" src="${ctx}/logined/appraisal/js/staff/otherPeopleScore_details.js?version=${version}"></script>
...
<div class="iframe_right_content">
    ...
    <div class="kh_score_box">
        ...
        <div class="kh_score_detail">
            ...
            <ul class="khinfo_list">
                <li>
                    <span class="khinfo_list_title">我的评语：</span>
                </li>
            </ul>
            <div class="pdl30">
                <p class="pingjia_content" id="khpy"></p>
            </div>
            <div class="btn_container2">
                <span class="btn_inline btn_gray" onclick="goback()">上一步</span>
                <span class="btn_inline btn_white ml15" onclick="postend()">提交</span>
                <span class="btn_inline btn_white ml15" onclick="post()">提交并继续打分</span>
            </div>
        </div>
    </div>
</div>
