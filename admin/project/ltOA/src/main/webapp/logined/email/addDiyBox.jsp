	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="inputTable">
               <tbody>
                      <tr>
                            ...
                            <td>
								<input name="emailBox.orderNo" id="orderNo" type="text" class="formText numberKeyUp" size="30" maxlength="3"
                      ...
                      <tr>
                            ...
                            <td>
                            	<input name="emailBox.boxName" id="boxName" type="text" class="formText" size="30"
