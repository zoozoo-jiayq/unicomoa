<%@ page language="java" import="java.util.*"  contentType="text/html; charset=UTF-8" pageEncoding="utf-8"  %>
  ...
  <div class="change hideDiv popo" id="changeIndex" style="display:none" >
     <ul>
        ...
        <li style="cursor:pointer;" onclick=" $('.hideDiv').hide();addTab('dwmh', 'http://www.qytx.com.cn', '门户首页', true, ''); "   > <img src="${ctx }flat/images/main/dwmh_icon.png"></img><h2>门户首页</h2> </li>
        ...
        <li style="cursor:pointer;" onclick=" $('.hideDiv').hide();addTab('gzpt', '${ctx}/logined/desktop/mainkpFix.jsp', '工作平台', true, '');" ><img src="${ctx }flat/images/main/rwmh_icon.png"></img><h2>工作平台</h2></li>
     </ul>
  </div>
  <%
