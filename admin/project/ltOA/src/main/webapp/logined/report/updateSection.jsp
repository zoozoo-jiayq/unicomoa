...
<script type="text/javascript" src="${ctx}js/logined/report/updateSection.js"></script>
...
<div class="input">
		...
		<input type="hidden" name="sectionId" id="sectionId" value="${param.sectionId}"/>
		 <div class="pageTitle"><em class="iconAdd">编辑标段</em></div>
		...
		<input hideFocus="" value="确 定" type="submit"  id="updateSection" name="updateSection">
