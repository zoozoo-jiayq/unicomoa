...
<script type="text/javascript" src="${ctx}js/logined/report/updateProject.js"></script>
...
<div class="input">
		 ...
		 <div class="pageTitle"><em class="iconAdd">编辑项目</em></div>
		...
		<input hideFocus="" value="确 定" type="submit"  id="updateProject" name="updateProject">
