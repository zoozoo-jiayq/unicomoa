...
<head>
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript" src="${ctx}/js/logined/report/projectBDList.js"></script>
</head>
<body>
     <div class="list">
		<div class="listbtn">
			...
			<div class="fbutton">
		      ...
		      <div class="fr">
							...
							<label >项目名称：</label><input id="projectName" placeholder="请输入项目名称"  maxlength="20" type="text" class="formText" style="width:200px" />
