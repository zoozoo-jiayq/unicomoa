...
<script type="text/javascript" src="${ctx}/js/logined/notice/manage/updateForUsed.js?v=${jsversion}"></script>
...
<div class="input">
    ...
    <table border="0" class="inputTable">
        <tr>
            ...
            <td>${column.title}<input id="lmName" type="hidden" maxlength="8" class="formText" value="${column.title}"  readonly="readonly"/></td>
        ...
        <tr>
           ...
           <td colspan="3">
           		<textarea id="userNames" class="readOnlyText" style="float:left; width:80%;" readonly="readonly">${column.issuerName}</textarea>
           	</td>
        </tr>
        <tr>
           <th><span class="requireField">*</span><label>发布范围：</label></th>
           <td colspan="3">
           		<textarea id="fwNames" class="readOnlyText" style="float:left; width:80%;" readonly="readonly">${column.distributionName}</textarea>
           		</td>
        </tr>
        <tr>
