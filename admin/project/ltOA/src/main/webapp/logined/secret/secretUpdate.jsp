...
<script type="text/javascript" src="${ctx}js/logined/secret/secretUpdate.js"></script>
</head>
<body>
<input type="hidden" id="id" value="${secret.id }" />
	 <div class="formPage">
	  <div class="formbg">
	                ...
	                <tr>
	                  ...
	                  <td>
	                  		<select id="select" disabled="disabled">
	                  			<option value="${secret.attribute}" >${secret.attributeName}</option>
	                  		</select>
	                  </td>
	                </tr>
	                <tr>
	                    <th><label>控制范围：</label></th>
	                    <td><textarea readonly="readonly" rows="3" class="readOnlyTextarea" id="applyUserNames">${secret.applyUserNames}</textarea>
	                    	<span class="addMember">
	                  	  	...
	                  	  	<input type="hidden" id="applyUserIds" value="${secret.applyUserIds}"/>
	                    </td>
	                </tr>
	                <tr>
	                    <th><label>不可查看人员：</label></th>
	                    <td><textarea readonly="readonly" rows="3" class="readOnlyTextarea" id="invisibleUserNames">${secret.invisibleUserNames}</textarea>
	                    	<span class="addMember">
	                  	  	...
	                  	  	<input type="hidden" id="invisibleUserIds" value="${secret.invisibleUserIds}"/>
						</td>
	                </tr>
	             </table>
	         </div>
