...
<script type="text/javascript" src="${ctx}/wap/js/logined/report/list.js"></script>
</head>
<body>
<input type="hidden" id="userId" value="<%=request.getParameter("userId")!=null?request.getParameter("userId"):"0"%>"/>
<header><li id="categoryLi" style="cursor:pointer;" class="btnTxl"></li><h1>报表批阅</h1></header>
<article>
