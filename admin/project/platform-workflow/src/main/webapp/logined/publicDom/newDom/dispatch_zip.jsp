...
<title>公文管理-公文归档</title>
<jsp:include page="publicDomHead.jsp" />
</head>
<body>
<input type="hidden" id="menu" value="10"/>
	<input type="hidden" id="searchType" value="processing"/>
<div class="list">
<!-- 	<ul class="tab" style="margin-bottom:10px">
		<li><a href="${ctx}/logined/publicDom/newDom/gather_zip.jsp" >收文归档</a> </li>
		<li  class="current"><a href="#" >发文归档</a> </li>
	</ul> -->
