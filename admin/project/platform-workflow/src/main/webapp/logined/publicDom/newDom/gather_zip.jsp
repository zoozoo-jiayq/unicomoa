...
<body>
<input type="hidden" id="menu" value="9"/>
	<input type="hidden" id="searchType" value="processing"/>
<div class="list">
<!-- 	<ul class="tab" style="margin-bottom:10px">
		<li class="current"><a href="#" >收文归档</a> </li>
		<li><a href="${ctx}/logined/publicDom/newDom/dispatch_zip.jsp" >发文归档</a> </li>
	</ul> -->
      ...
      <tbody>
        <tr>
          ...
          <td class="right">
            ...
            <input type="text" class="formText searchkey" id="title" placeholder="标题/文号/公文类型" />
            </span>
            <input type="button" class="searchButton" value="查询" id="searchButton" /></td>
           <td style="width:120px;"><div class="fButton greenBtn"> <span class="batch" onclick="batchZip();">批量归档</span> </div></td>
        </tr>
      </tbody>
    </table>
  </div>
	<table cellpadding="0" cellspacing="0" id="viewlist"  class="pretty dataTable">
		<thead>
			<tr>
				...
				<th nowrap="nowrap">来文单位</th>
				<!-- <th nowrap="nowrap">收文部门</th> -->
				<th nowrap="nowrap">公文类型</th>
				<!--<th nowrap="nowrap">密级</th>
				<th nowrap="nowrap">缓急</th>-->
				<th width="nowrap">应读人数</th>
				<th width="nowrap">实读人数</th>
				<th nowrap="nowrap">登记人</th>
				<th nowrap="nowrap">登记时间</th>
