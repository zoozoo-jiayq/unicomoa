...
<!-- 	<ul class="tab" style="margin-bottom:10px">
		<li class="current"><a href="#" >待登记</a> </li>
		<li><a href="${ctx}/logined/publicDom/newDom/gather_register_complete.jsp" >已登记</a> </li>
	</ul> -->
	<div class="listbtn">
<!--  -->
      ...
      <tbody>
        <tr>
          ...
          <td class="right">
            ...
            <td style="width:120px;"><div class="fButton greenBtn"> <span class="add" onclick="add();">新增收文</span> </div></td>
        </tr>
      </tbody>
    </table>
  </div>
	...
	<table cellpadding="0" cellspacing="0" id="viewlist"  class="pretty dataTable">
		<thead>
			<tr>
				...
				<th nowrap="nowrap" class="right_bdr0">操作</th>
			</tr>
		</thead>
		<tbody>
...
function add(){
	window.top.addTab(Math.random(),"${ctx}dom/gather!toAdd.action","新增收文");
}
</script>
</body>
</html>