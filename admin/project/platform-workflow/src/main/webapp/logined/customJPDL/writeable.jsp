...
<script type="text/javascript" src="${ctx}/js/logined/customJPDL/writeable.js"></script>
</head>
...
<body>
    ...
    <div class="formPage">
  <div class="formbg">
      <div class="big_title">步骤：${node.nodeName } <em>编辑可写字段(可写字段对于本步骤主办人、经办人均为可写)</em></div>
      <div class="bmzd">
