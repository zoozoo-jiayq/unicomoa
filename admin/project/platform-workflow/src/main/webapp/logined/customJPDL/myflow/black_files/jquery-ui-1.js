		...
		_mouseDown : function(a) {
			...
			if (!a.originalEvent.mouseHandled) {
				...
				var b = this, e = a.which == 1, f = typeof this.options.cancel == "string"
						? c(a.target).parents().add(a.target)
...
(function(c) {
	...
	c.fn.position = function(a) {
		...
		a = c.extend({}, a);
		var b = c(a.of), d = (a.collision || "flip").split(" "), e = a.offset
				? a.offset.split(" ")
				: [0, 0], g, h, i;
		if (a.of.nodeType === 9) {
			g = b.width();
		...
		c.each(["my", "at"], function() {
					var f = (a[this] || "").split(" ");
					if (f.length === 1)
						f = m.test(f[0]) ? f.concat(["center"]) : n.test(f[0])
								? ["center"].concat(f)
								: ["center", "center"];
		...
		flip : {
			...
			top : function(a, b) {
				if (b.at[1] !== "center") {
					...
					var e = b.my[1] === "top"
							? -b.elemHeight
							: b.my[1] === "bottom" ? b.elemHeight : 0, g = b.at[1] === "top"
							? b.targetHeight
	...
	if (!c.offset.setOffset) {
		c.offset.setOffset = function(a, b) {
			...
			var d = c(a), e = d.offset(), g = parseInt(
					c.curCSS(a, "top", true), 10)
					|| 0, h = parseInt(c.curCSS(a, "left", true), 10) || 0;
			e = {
				top : b.top - e.top + g,
	...
	d.widget("ui.draggable", d.ui.mouse, {
		...
		_createHelper : function(a) {
			...
			a = d.isFunction(b.helper)
					...
					: b.helper == "clone" ? this.element.clone() : this.element;
		...
		_generatePosition : function(a) {
			var b = this.options, c = this.cssPosition == "absolute"
					&& !(this.scrollParent[0] != document && d.ui.contains(
							this.scrollParent[0], this.offsetParent[0]))
					? this.offsetParent
					: this.scrollParent, f = /(html|body)/i.test(c[0].tagName), e = a.pageX, g = a.pageY;
	...
	d.ui.plugin.add("draggable", "snap", {
		...
		drag : function(a, b) {
			for (var c = d(this).data("draggable"), f = c.options, e = f.snapTolerance, g = b.offset.left, n = g
				...
				if (i - e < g && g < k + e && j - e < m && m < l + e
						|| i - e < g && g < k + e && j - e < o && o < l + e
						|| i - e < n && n < k + e && j - e < m && m < l + e
						|| i - e < n && n < k + e && j - e < o && o < l + e) {
					if (f.snapMode != "inner") {
						var p = Math.abs(j - o) <= e, q = Math.abs(l - m) <= e, r = Math
								.abs(i - n) <= e, s = Math.abs(k - g) <= e;
						if (p)
...
(function(e) {
	e.widget("ui.resizable", e.ui.mouse, {
			...
			this._renderAxis = function(h) {
				...
				for (var i in this.handles) {
					...
					if (this.elementIsWrapper
						...
						k = /sw|ne|nw|se|n|s/.test(i) ? j.outerHeight() : j
								.outerWidth();
						j = [
								"padding",
		...
		_respectSize : function(b) {
			var a = this.options, c = this.axis, d = l(b.width) && a.maxWidth
					&& a.maxWidth < b.width, f = l(b.height) && a.maxHeight
					&& a.maxHeight < b.height, g = l(b.width) && a.minWidth
					&& a.minWidth > b.width, h = l(b.height) && a.minHeight
					&& a.minHeight > b.height;
			if (g)
				b.width = a.minWidth;
			if (h)
...
(function(e) {
	e.widget("ui.autocomplete", {
		...
		_create : function() {
			...
			this.menu = e("<ul></ul>").addClass("ui-autocomplete").appendTo(e(
	...
	e.widget("ui.menu", {
		...
		activate : function(a, b) {
			...
			if (this.hasScroll()) {
				var c = b.offset().top - this.element.offset().top, d = this.element
						.attr("scrollTop"), f = this.element.height();
				if (c < 0)
					this.element.attr("scrollTop", d + c);
				else
					c > f
							&& this.element.attr("scrollTop", d + c - f
											+ b.height())
			}
		...
		move : function(a, b, c) {
			if (this.active) {
				...
				a.length ? this.activate(c, a) : this.activate(c, this.element
								.children(b))
			} else
		...
		_create : function() {
			...
			if (this.type === "checkbox")
				this.buttonElement.bind("click.button", function() {
							...
							b.buttonElement.attr("aria-pressed",
									b.element[0].checked)
						});
		...
		_resetButton : function() {
			if (this.type === "input")
				...
				var b = this.buttonElement
						.removeClass("ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only"), c = a("<span></span>")
						.addClass("ui-button-text").html(this.options.label)
						.appendTo(b.empty()).text(), d = this.options.icons, e = d.primary
						&& d.secondary;
...
(function(c, j) {
	c.widget("ui.dialog", {
		...
		_create : function() {
			...
			var a = this, b = a.options, d = b.title || a.originalTitle
					|| "&#160;", f = c.ui.dialog.getTitleId(a.element), g = (a.uiDialog = c("<div></div>"))
			...
			(a.uiDialogTitlebarCloseText = c("<span></span>"))
					...
					.appendTo(h);
			c("<span></span>").addClass("ui-dialog-title").attr("id", f)
					.html(d).prependTo(e);
		...
		_createButtons : function(a) {
			var b = this, d = false, f = c("<div></div>")
					...
					.addClass("ui-dialog-buttonset").appendTo(f);
			...
			if (d) {
				c.each(a, function(e, h) {
							e = c('<button type="button"></button>').text(e)
									.click(function() {
												h
														.apply(b.element[0],
																arguments)
		...
		_makeDraggable : function() {
			...
			b.uiDialog.draggable({
						...
						stop : function(e, h) {
							d.position = [h.position.left - f.scrollLeft(),
	...
	c.extend(c.ui.dialog.overlay, {
		...
		destroy : function(a) {
			this.oldInstances.push(this.instances.splice(c.inArray(a,
							this.instances), 1)[0]);
	...
	d.widget("ui.slider", d.ui.mouse, {
		...
		_create : function() {
			...
			d(".ui-slider-handle", this.element).length === 0
					&& d("<a href='#'></a>").appendTo(this.element)
			...
			this.handles.keydown(function(c) {
				...
				if (!a.options.disabled) {
					...
					i = a.options.step;
					h = a.options.values && a.options.values.length ? (g = a
							.values(f)) : (g = a.value());
					switch (c.keyCode) {
						case d.ui.keyCode.HOME :
							g = a._valueMin();
		...
		_refreshValue : function() {
			var a = this.options.range, b = this.options, c = this, e = !this._animateOff
					? b.animate
					: false, f, h = {}, g, i, j, l;
			if (this.options.values && this.options.values.length)
				this.handles.each(function(k) {
							...
							h[c.orientation === "horizontal"
									? "left"
									: "bottom"] = f + "%";
							d(this).stop(1, 1)[e ? "animate" : "css"](h,
									b.animate);
	...
	d.widget("ui.tabs", {
		...
		_tabify : function(a) {
			...
			this.anchors.bind(c.event + ".tabs", function() {
				var g = this, f = d(g).closest("li"), j = b.panels
		...
		_getIndex : function(a) {
			if (typeof a == "string")
				a = this.anchors
						.index(this.anchors.filter("[href$=" + a + "]"));
			return a
		},
		destroy : function() {
			var a = this.options;
		...
		add : function(a, e, b) {
			...
			e = d(h.tabTemplate.replace(/#\{href\}/g, a).replace(/#\{label\}/g,
					e));
			...
			var i = d("#" + a);
			i.length
					|| (i = d(h.panelTemplate).attr("id", a).data(
							"destroy.tabs", true));
			i
			...
			this._trigger("add", null, this
							._ui(this.anchors[b], this.panels[b]));
			return this
		},
		remove : function(a) {
			a = this._getIndex(a);
		...
		enable : function(a) {
			...
			if (d.inArray(a, e.disabled) != -1) {
				...
				this._trigger("enable", null, this._ui(this.anchors[a],
								this.panels[a]));
				return this
			}
		},
		disable : function(a) {
			...
			if (a != e.selected) {
				...
				e.disabled.push(a);
				e.disabled.sort();
				this._trigger("disable", null, this._ui(this.anchors[a],
								this.panels[a]))
			}
			return this
		},
		...
		load : function(a) {
			a = this._getIndex(a);
			var e = this, b = this.options, c = this.anchors.eq(a)[0], h = d
					.data(c, "load.tabs");
			this.abort();
	...
	d.extend(L.prototype, {
		...
		_enableDatepicker : function(a) {
			...
			if (b.hasClass(this.markerClassName)) {
				...
				if (e == "input") {
					...
					b.children("." + this._inlineClass).children()
							.removeClass("ui-state-disabled");
			...
			if (d.datepicker._datepickerShowing)
				switch (a.keyCode) {
					case 9 :
						...
						break;
					case 13 :
						c = d("td." + d.datepicker._dayOverClass, b.dpDiv)
								.add(d("td." + d.datepicker._currentClass,
										b.dpDiv));
						c[0]
		...
		_doKeyPress : function(a) {
			...
			if (d.datepicker._get(b, "constrainInput")) {
				b = d.datepicker._possibleChars(d.datepicker._get(b,
						"dateFormat"));
				var c = String.fromCharCode(a.charCode == G
						? a.keyCode
						: a.charCode);
		...
		_showDatepicker : function(a) {
			...
			if (!(d.datepicker._isDisabledDatepicker(a) || d.datepicker._lastInput == a)) {
				...
				d.datepicker._curInst && d.datepicker._curInst != b
		...
		_updateDatepicker : function(a) {
			...
			a.dpDiv
					...
					.bind("mouseover", function() {
						if (!b._isDisabledDatepicker(a.inline ? a.dpDiv
								.parent()[0] : a.input[0])) {
			...
			var e = c[1];
			e > 1
					? a.dpDiv.addClass("ui-datepicker-multi-" + e).css("width",
							17 * e + "em")
					: a.dpDiv
		...
		_checkOffset : function(a, b, c) {
			...
			b.left -= Math.min(b.left, b.left + e > g && g > e ? Math
							.abs(b.left + e - g) : 0);
			b.top -= Math.min(b.top, b.top + f > k && k > f
							? Math.abs(f + i)
							: 0);
			return b
		},
		...
		parseDate : function(a, b, c) {
			...
			for (var e = (c ? c.shortYearCutoff : null)
					|| this._defaults.shortYearCutoff, f = (c
					? c.dayNamesShort
					: null)
		...
		_determineDate : function(a, b, c) {
			...
			if (b = (b = b == null ? c : typeof b == "string"
					? f(b)
					: typeof b == "number" ? isNaN(b) ? c : e(b) : b)
		...
		_generateHTML : function(a) {
			...
			var c = this._get(a, "isRTL"), e = this._get(a, "showButtonPanel"), f = this
					...
					._daylightSavingAdjust(!a.currentDay
							...
							: new Date(a.currentYear, a.currentMonth,
									a.currentDay)), j = this._getMinMaxDate(a,
			...
			n = !h ? n : this.formatDate(n, this
							._daylightSavingAdjust(new Date(m, g - k, 1)), this
							._getFormatConfig(a));
			...
			var s = this._get(a, "dayNamesMin"), z = this._get(a, "monthNames"), v = this
					._get(a, "monthNamesShort"), p = this._get(a,
					"beforeShowDay"), w = this._get(a, "showOtherMonths"), H = this
					._get(a, "selectOtherMonths");
			this._get(a, "calculateWeek");
			for (var M = this._getDefaultDate(a), I = "", C = 0; C < i[0]; C++) {
				for (var N = "", D = 0; D < i[1]; D++) {
					var J = this._daylightSavingAdjust(new Date(m, g,
							a.selectedDay)), t = " ui-corner-all", x = "";
					if (l) {
					...
					x += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix'
							...
							+ this._generateMonthYearHeader(a, g, m, j, o,
									C > 0 || D > 0, z, v)
					...
					for (var O = 0; O < A; O++) {
						x += "<tr>";
						var P = !k ? "" : '<td class="ui-datepicker-week-col">'
								+ this._get(a, "calculateWeek")(q) + "</td>";
						for (t = 0; t < 7; t++) {
							var F = p ? p.apply(a.input ? a.input[0] : null,
									[q]) : [true, ""], B = q.getMonth() != g, K = B
									&& !H || !F[0] || j && q < j || o && q > o;
							P += '<td class="'
									+ ((t + h + 6) % 7 >= 5
		...
		_generateMonthYearHeader : function(a, b, c, e, f, h, i, g) {
			var k = this._get(a, "changeMonth"), l = this._get(a, "changeYear"), u = this
					._get(a, "showMonthAfterYear"), j = '<div class="ui-datepicker-title">', o = "";
			if (h || !k)
				...
				o += '<select class="ui-datepicker-month" onchange="DP_jQuery_'
						+ y + ".datepicker._selectMonthYear('#" + a.id
						+ "', this, 'M');\" onclick=\"DP_jQuery_" + y
			...
			if (h || !l)
				...
				for (j += '<select class="ui-datepicker-year" onchange="DP_jQuery_'
						...
						+ y
						+ ".datepicker._clickMonthYear('#" + a.id + "');\">"; b <= g; b++)
					j += '<option value="' + b + '"'
							+ (b == c ? ' selected="selected"' : "") + ">" + b
							+ "</option>";
				j += "</select>"
			}
...
(function(b, c) {
	b.widget("ui.progressbar", {
		...
		_refreshValue : function() {
			var a = this.value();
			this.valueDiv.toggleClass("ui-corner-right", a === this.max)
					.width(a + "%");
...
jQuery.effects || function(f, j) {
	...
	f.effects.animateClass = function(c, a, b, d) {
		...
		return this.each(function() {
			var e = f(this), g = e.attr("style") || " ", h = o(n.call(this)), q, u = e
					.attr("className");
...
(function(b) {
	b.effects.clip = function(e) {
		return this.queue(function() {
			var a = b(this), i = ["position", "top", "left", "height", "width"], f = b.effects
					.setMode(a, e.options.mode || "hide"), c = e.options.direction
					|| "vertical";
			b.effects.save(a, i);
			a.show();
...
(function(c) {
	c.effects.fold = function(a) {
		return this.queue(function() {
					...
					h[l[0]] = d == "show" ? f[0] : g;
					i[l[1]] = d == "show" ? f[1] : 0;
					e.animate(h, k, a.options.easing).animate(i, k,
...
(function(c) {
	...
	c.effects.size = function(b) {
		return this.queue(function() {
			var a = c(this), e = ["position", "top", "left", "width", "height",
					"overflow", "opacity"], g = ["position", "top", "left",
					"overflow", "opacity"], h = ["width", "height", "overflow"], i = ["fontSize"], f = [
