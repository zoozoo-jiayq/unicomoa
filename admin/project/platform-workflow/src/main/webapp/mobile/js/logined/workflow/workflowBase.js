...
function HoursDiff(sDate1, sDate2){ //sDate1和sDate2是2002-12-18 13:00:00格式   
	var aDate,aDate1, oDate1, oDate2, iHours;
	aDate = sDate1.split(" ")[0].split("-");
	aDate1=sDate1.split(" ")[1].split(":");
	oDate1 = Date.parse(aDate[0] + '/' + aDate[1] + '/' + aDate[2]+' '+aDate1[0]+":00:00"); //转换为12-18-2002 13:00:00格式   
	aDate = sDate2.split(" ")[0].split("-");
	aDate1=sDate2.split(" ")[1].split(":");
	oDate2 = Date.parse(aDate[0] + '/' + aDate[1] + '/' + aDate[2]+' '+aDate1[0]+":00:00");   
