...
<div class="container-fluid">
    <ul>
        <li class=  "input-group">
            <span class="input-group-addon bdnone ltext">同意</span>
        </li>
        <li class="input-group">
            <span class="input-group-addon bdnone">
                <textarea placeholder="请输入批复内容（非必填）" id="advice_agree"></textarea>
            </span>
        </li>
   </ul>
   <div class="buttonArea">
        <button class="btn btn-primary" type="button" id="but_agree">提交</button>
   </div>        
</div>
</body>
